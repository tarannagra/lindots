...
## if system == dark, then dark scheme; else light
...
c.url.auto_search = "naive"  # native/dns/never/schemeless
c.url.searchengines = {
...
config.bind("lx", "config-source")
config.bind("Sh", "history")

config.bind("/", "cmd-set-text /")

# highlight link and copy it
config.bind("Ym", "hint links yank")
